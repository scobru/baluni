...
import uniswapV3FactoryAbi from '../../api/abis/uniswap/Factory.json'
import uniswapV3PoolAbi from '../../api/abis/uniswap/Pool.json'
import erc20Abi from '../../api/abis/common/ERC20.json' // Assuming you have ERC20 ABI for fetching decimals
